...
func (m *simpleSystemManager) WhenProcessRunning(ctx context.Context) error { return nil }
...
func (m *simpleSystemManager) WhenStorageReady(ctx context.Context) error            { return nil }
func (m *simpleSystemManager) WaitForJuiceFS(ctx context.Context) error              { return nil }
func (m *simpleSystemManager) WaitForOverlay(ctx context.Context) error              { return nil }
func (m *simpleSystemManager) CheckpointWithStream(ctx context.Context, checkpointID string, streamCh chan<- libapi.StreamMessage) error {
	defer close(streamCh)
	return nil
}
func (m *simpleSystemManager) RestoreWithStream(ctx context.Context, checkpointID string, streamCh chan<- libapi.StreamMessage) error {
	defer close(streamCh)
	return nil
}
func (m *simpleSystemManager) ListCheckpoints(ctx context.Context) ([]libapi.CheckpointInfo, error) {
	return []libapi.CheckpointInfo{}, nil
}
func (m *simpleSystemManager) ListCheckpointsByHistory(ctx context.Context, version string) ([]string, error) {
	return []string{}, nil
}
func (m *simpleSystemManager) GetCheckpoint(ctx context.Context, checkpointID string) (*libapi.CheckpointInfo, error) {
